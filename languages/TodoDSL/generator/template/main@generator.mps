...
<model ref="r:d0a34136-43ba-4744-9f10-7d5c029db04d(main@generator)">
  ...
  <node concept="bUwia" id="L54_aDYH_D">
    ...
    <node concept="3lhOvk" id="L54_aDYRK$" role="3lj3bC">
      ...
      <ref role="3lhOvi" node="L54_aDYRKA" resolve="map_TodoList" />
    </node>
  </node>
  <node concept="312cEu" id="L54_aDYRKA">
    <property role="TrG5h" value="map_TodoList" />
    <node concept="3Tm1VV" id="L54_aDYRKB" role="1B3o_S" />
    <node concept="n94m4" id="L54_aDYRKC" role="lGtFl">
